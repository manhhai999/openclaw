...
export const TOOL_DISPLAY_CONFIG: ToolDisplayConfig = {
  ...
  tools: {
    ...
    enterplanmode: {
      ...
      detailKeys: ["goal", "notes"],
    },
    exitplanmode: {
      emoji: "✅",
      title: "Exit Plan Mode",
      detailKeys: ["summary", "approved"],
    },
    enterworktree: {
      emoji: "🌿",
      title: "Enter Worktree",
      detailKeys: ["name", "branch", "baseRef", "cleanup"],
    },
    exitworktree: {
      emoji: "🧹",
      title: "Exit Worktree",
      detailKeys: ["cleanup", "force"],
    },
    team_create: {
      emoji: "🧑‍🤝‍🧑",
      title: "Team Create",
      detailKeys: ["goal", "members.0.task"],
    },
    team_status: {
      emoji: "📡",
      title: "Team Status",
    ...
    team_close: {
      emoji: "🛑",
      title: "Team Close",
      detailKeys: ["teamId", "summary", "cancelActive"],
    },
    gateway: {
      emoji: "🔌",
      title: "Gateway",
