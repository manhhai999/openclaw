...
> {
  ...
  const next = await updateSessionStore(storePath, (store) => {
    ...
    const nextEntry: SessionEntry = {
      ...
      planMode: currentEntry?.planMode,
      planArtifact: currentEntry?.planArtifact,
      worktreeMode: currentEntry?.worktreeMode,
      worktreeArtifact: currentEntry?.worktreeArtifact,
