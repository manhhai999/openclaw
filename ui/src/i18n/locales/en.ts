...
export const en: TranslationMap = {
  ...
  dashboard: {
    ...
    quickSettings: {
      ...
      personal: {
        title: "Personal",
        browserOnly: "This browser only",
        nameLabel: "Name",
        namePlaceholder: "You",
        avatarLabel: "Avatar text / emoji",
  ...
  cron: {
    ...
    quickCreate: {
      ...
      schedules: {
        everyMorning: { label: "Every morning", description: "Daily at 8:00 AM" },
        everyEvening: { label: "Every evening", description: "Daily at 6:00 PM" },
        hourly: { label: "Hourly", description: "Every hour" },
        weekdays: { label: "Weekdays", description: "Mon–Fri at 9:00 AM" },
        weekly: { label: "Weekly", description: "Every Monday at 9:00 AM" },
        once: { label: "Run once", description: "One-time, delete after run" },
      },
      delivery: {
        notify: { label: "Notify me", description: "Deliver results to chat" },
        silent: { label: "Silent", description: "Run without notification" },
        isolated: { label: "Independent session", description: "Run in its own session" },
      },
    },
    form: {
      editJob: "Edit Job",
