...
export const en: TranslationMap = {
  ...
  nodes: {
    ...
    execApprovals: {
      ...
      security: {
        title: "Security",
        defaultSubtitle: "Default security mode.",
      },
      ask: {
        title: "Ask",
        defaultSubtitle: "Default prompt policy.",
      },
      askFallback: {
        title: "Ask fallback",
        defaultSubtitle: "Applied when the UI prompt is unavailable.",
        fallback: "Fallback",
      },
      autoAllowSkills: {
        title: "Auto-allow skill CLIs",
        defaultSubtitle: "Allow skill executables listed by the Gateway.",
  ...
  subtitles: {
    ...
    plans: "Orchestration plan inspect and lifecycle controls.",
  ...
  dreaming: {
    ...
    advanced: {
      ...
      phaseHitsCount: "{count} phase hit",
    },
    stats: {
    ...
    diary: {
      ...
      subtabs: {
        dreams: "Dreams",
        importedInsights: "Imported Insights",
      ...
      memoryWikiDisabled: "Memory Wiki is not enabled",
      memoryWikiDisabledHint1Prefix:
        "Imported Insights and Memory Palace are provided by the bundled",
      memoryWikiDisabledHint1Suffix: "plugin.",
      memoryWikiDisabledHint2Prefix: "Enable",
      memoryWikiDisabledHint2Suffix: ", then reload this tab.",
      wikiPreviewTitle: "Wiki page",
      loadingWikiPage: "Loading wiki page…",
      previewHint: "Showing the first chunk of this page.",
      previewHintWithLines: "Showing the first chunk of this page ({count} total lines).",
      noWikiPageFound: "No wiki page found for {lookup}.",
      ...
      emptyMemoryPalace: "Memory palace is not populated yet",
      ...
      importClusterIntro: "Imported chats clustered around {label}.",
      importWithheldPendingReview: "{count} digests were withheld pending review.",
      chatCount: "{count} chats",
      sensitiveCount: "{count} sensitive",
      signalsCount: "{count} signals",
      messagesCount: "{count} messages",
      potentialSignals: "Potentially useful signals",
      ...
      contradictionsCount: "{count} contradictions",
      palaceIntro: "Compiled wiki pages currently grouped under {label}.",
  ...
  dashboard: {
    ...
    attentionItems: {
      ...
      missingOperatorReadScopeTitle: "Missing operator.read scope",
      missingOperatorReadScopeDescription:
        "This connection does not have the operator.read scope. Some features may be unavailable.",
      missingDependenciesTitle: "Skills with missing dependencies",
      moreCount: " +{count} more",
      blockedSkillsTitle: "Blocked skills ({count})",
      failedCronJobsTitle: "Failed cron jobs ({count})",
      overdueJobsTitle: "Overdue jobs ({count})",
    },
  },
  settings: {
    root: "Settings",
  ...
  skillsPage: {
    ...
    shownCount: "{count} shown",
    emptyDisconnected: "Not connected to gateway.",
    emptyNoSkills: "No skills found.",
    chips: {
      bundled: "bundled",
      eligible: "eligible",
      blocked: "blocked",
  ...
  debugPage: {
    ...
    securityAudit:
      "Security audit: {summary}{info}. Run openclaw security audit --deep for details.",
    status: "Status",
  ...
  cron: {
    ...
    form: {
      ...
      failureAlertDeliveryMode: "Alert mode",
      failureAlertDeliveryModeAnnounce: "Announce (via channel)",
