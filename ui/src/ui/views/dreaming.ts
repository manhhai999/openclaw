...
function formatKindLabel(kind: "entity" | "concept" | "source" | "synthesis" | "report"): string {
  return t(`dreaming.diary.kinds.${kind}`);
}
...
function formatImportBadge(item: {
  ...
  if (item.digestStatus === "withheld") {
    return t("dreaming.diary.importBadges.needsReview");
  }
  return t(`dreaming.diary.importBadges.${item.riskLevel}`);
}
...
async function openWikiPreview(lookup: string, props: DreamingProps): Promise<void> {
  ...
  try {
    ...
    if (!preview) {
      _wikiPreviewError = t("dreaming.diary.noWikiPageFound", { lookup });
      return;
    }
        ...
        <div class="dreams-diary__preview-header">
          <div>
            <div class="dreams-diary__preview-title">
              ${_wikiPreviewTitle || t("dreaming.diary.wikiPreviewTitle")}
            </div>
        ...
        <div class="dreams-diary__preview-body">
          ${_wikiPreviewLoading
            ? html`<div class="dreams-diary__empty-text">
                ${t("dreaming.diary.loadingWikiPage")}
              </div>`
            : _wikiPreviewError
                  ...
                  ${_wikiPreviewTruncated
                    ? html`
                        <div class="dreams-diary__preview-hint">
                          ${_wikiPreviewTotalLines !== null
                            ? t("dreaming.diary.previewHintWithLines", {
                                count: String(_wikiPreviewTotalLines),
                              })
                            : t("dreaming.diary.previewHint")}
                        </div>
                      `
                    : nothing}
...
function renderDiarySubtabExplainer() {
  switch (_diarySubTab) {
    case "dreams":
      return html`<p class="dreams-diary__explainer">${t("dreaming.diary.explainers.dreams")}</p>`;
    case "insights":
      return html`<p class="dreams-diary__explainer">
        ${t("dreaming.diary.explainers.importedInsights")}
      </p>`;
    case "palace":
      return html`<p class="dreams-diary__explainer">
        ${t("dreaming.diary.explainers.memoryPalace")}
      </p>`;
  }
  return nothing;
}
        ...
        ${renderAdvancedEntryList({
          ...
          meta: (entry) => [
            entry.groundedCount > 0
              ...
              : "",
            entry.recallCount > 0
              ? t("dreaming.diary.recallsCount", { count: String(entry.recallCount) })
              : "",
            entry.dailyCount > 0
              ? t("dreaming.diary.dailyCount", { count: String(entry.dailyCount) })
              : "",
          ],
        })}
        ${renderAdvancedEntryList({
          ...
          meta: (entry) => [
            ...
            entry.phaseHitCount > 0
              ? t("dreaming.advanced.phaseHitsCount", { count: String(entry.phaseHitCount) })
              : "",
          ],
        })}
        ${renderAdvancedEntryList({
...
function renderDiaryImportsSection(props: DreamingProps) {
  ...
  if (props.wikiImportInsightsLoading && clusters.length === 0) {
    return html`
      <div class="dreams-diary__empty">
        <div class="dreams-diary__empty-text">${t("dreaming.diary.loadingImportedInsights")}</div>
      </div>
    `;
  }
  ...
  if (clusters.length === 0) {
    return html`
      <div class="dreams-diary__empty">
        <div class="dreams-diary__empty-text">${t("dreaming.diary.noImportedInsights")}</div>
        <div class="dreams-diary__empty-hint">${t("dreaming.diary.noImportedInsightsHint")}</div>
      </div>
    `;
  }
  ...
  return html`
    ...
    <article class="dreams-diary__entry" key="imports-${cluster.key}">
      ...
      <div class="dreams-diary__date">
        ${cluster.label} · ${t("dreaming.diary.chatCount", { count: String(cluster.itemCount) })}
        ${cluster.highRiskCount > 0
          ? html`·
            ${t("dreaming.diary.sensitiveCount", {
              count: String(cluster.highRiskCount),
            })}`
          : nothing}
        ${cluster.preferenceSignalCount > 0
          ? html`·
            ${t("dreaming.diary.signalsCount", {
      ...
      <div class="dreams-diary__prose">
        <p class="dreams-diary__para">
          ${t("dreaming.diary.importClusterIntro", { label: cluster.label.toLowerCase() })}
          ${cluster.withheldCount > 0
            ? ` ${t("dreaming.diary.importWithheldPendingReview", {
            ...
            >
              ...
              <div class="dreams-diary__insight-meta">
                ...
                ${item.activeBranchMessages > 0
                  ? ` · ${t("dreaming.diary.messagesCount", {
                      count: String(item.activeBranchMessages),
                    })}`
                  : ""}
              </div>
              ...
              ${item.candidateSignals.length > 0
                ? html`
                    <div class="dreams-diary__insight-list">
                      <strong>${t("dreaming.diary.potentialSignals")}</strong>
              ...
              ${item.correctionSignals.length > 0
                ? html`
                    <div class="dreams-diary__insight-list">
                      <strong>${t("dreaming.diary.correctionsOrRevisions")}</strong>
              ...
              ${expanded
                ? html`
                    <div class="dreams-diary__insight-list">
                      <strong>${t("dreaming.diary.importDetails")}</strong>
                      ${item.firstUserLine
                        ? html`
                            <p class="dreams-diary__insight-line">
                              <strong>${t("dreaming.diary.startedWith")}</strong>
                              ${item.firstUserLine}
                            </p>
                          `
                        : nothing}
                      ${item.lastUserLine && item.lastUserLine !== item.firstUserLine
                        ? html`
                            <p class="dreams-diary__insight-line">
                              <strong>${t("dreaming.diary.endedOn")}</strong>
                              ${item.lastUserLine}
                            </p>
                          `
                        : nothing}
                      <p class="dreams-diary__insight-line">
                        <strong>${t("dreaming.diary.messages")}</strong>
                        ${t("dreaming.diary.userAssistantCounts", {
                          user: String(item.userMessageCount),
                          assistant: String(item.assistantMessageCount),
                        })}
                      </p>
                      ${item.riskReasons.length > 0
                        ? html`
                            <p class="dreams-diary__insight-line">
                              <strong>${t("dreaming.diary.riskReasons")}</strong>
                      ...
                      ${item.labels.length > 0
                        ? html`
                            <p class="dreams-diary__insight-line">
                              <strong>${t("dreaming.diary.labels")}</strong>
                              ${item.labels.join(", ")}
                            </p>
                          `
                        : nothing}
              ...
              <div class="dreams-diary__insight-actions">
                ...
                >
                  ${expanded ? t("dreaming.diary.hideDetails") : t("dreaming.diary.details")}
                </button>
                <button
                  class="btn btn--subtle btn--sm"
                  @click=${(event: Event) => {
                ...
                >
                  ${t("dreaming.diary.openSourcePage")}
                </button>
              </div>
            </article>
          `;
...
function renderMemoryPalaceSection(props: DreamingProps) {
  ...
  if (props.wikiMemoryPalaceLoading && clusters.length === 0) {
    return html`
      <div class="dreams-diary__empty">
        <div class="dreams-diary__empty-text">${t("dreaming.diary.loadingMemoryPalace")}</div>
      </div>
    `;
  }
  ...
  if (clusters.length === 0) {
    return html`
      <div class="dreams-diary__empty">
        <div class="dreams-diary__empty-text">${t("dreaming.diary.emptyMemoryPalace")}</div>
        <div class="dreams-diary__empty-hint">${t("dreaming.diary.emptyMemoryPalaceHint")}</div>
      </div>
    `;
  }
  ...
  return html`
    ...
    <article class="dreams-diary__entry" key="palace-${cluster.key}">
      <div class="dreams-diary__accent"></div>
      <div class="dreams-diary__date">
        ${cluster.label} · ${t("dreaming.diary.pagesCount", { count: String(cluster.itemCount) })}
        ${cluster.claimCount > 0
          ? html`·
            ${t("dreaming.diary.claimsCount", {
              count: String(cluster.claimCount),
            })}`
          : nothing}
        ${cluster.questionCount > 0
          ? html`·
            ${t("dreaming.diary.questionsCount", {
              count: String(cluster.questionCount),
            })}`
          : nothing}
        ${cluster.contradictionCount > 0
          ? html`·
            ${t("dreaming.diary.contradictionsCount", {
      ...
      <div class="dreams-diary__prose">
        <p class="dreams-diary__para">
          ${t("dreaming.diary.palaceIntro", { label: cluster.label.toLowerCase() })}
          ${cluster.updatedAt
            ? ` ${t("dreaming.diary.latestUpdate", {
          ...
          return html`
            ...
            >
              ...
              ${item.claims.length > 0
                ? html`
                    <div class="dreams-diary__insight-list">
                      <strong>${t("dreaming.diary.claims")}</strong>
                      ${item.claims.map(
              ...
              ${item.questions.length > 0
                ? html`
                    <div class="dreams-diary__insight-list">
                      <strong>${t("dreaming.diary.openQuestions")}</strong>
                      ${item.questions.map(
              ...
              ${item.contradictions.length > 0
                ? html`
                    <div class="dreams-diary__insight-list">
                      <strong>${t("dreaming.diary.contradictions")}</strong>
              ...
              ${expanded
                ? html`
                    <div class="dreams-diary__insight-list">
                      <strong>${t("dreaming.diary.pageDetails")}</strong>
                      <p class="dreams-diary__insight-line">
                        <strong>${t("dreaming.diary.wikiPage")}</strong>
                        ${item.pagePath}
                      </p>
                      ${item.id
                        ? html`
                            <p class="dreams-diary__insight-line">
                              <strong>${t("dreaming.diary.id")}</strong>
                              ${item.id}
                            </p>
                          `
                        : nothing}
  ...
  return html`
    <section class="dreams-diary">
      <div class="dreams-diary__chrome">
        <div class="dreams-diary__header">
          ...
          <div class="dreams-diary__subtabs">
            ...
            >
              ${t("dreaming.diary.subtabs.dreams")}
            </button>
            <button
            ...
            >
              ${t("dreaming.diary.subtabs.importedInsights")}
            </button>
            <button
            ...
            >
              ${t("dreaming.diary.subtabs.memoryPalace")}
            </button>
          </div>
          <button
            class="btn btn--subtle btn--sm"
      ...
      ${memoryWikiUnavailable
        ? html`
            <div class="dreams-diary__empty">
              <div class="dreams-diary__empty-text">${t("dreaming.diary.memoryWikiDisabled")}</div>
              <div class="dreams-diary__empty-hint">
                ${t("dreaming.diary.memoryWikiDisabledHint1Prefix")}
                <code>memory-wiki</code>
                ${t("dreaming.diary.memoryWikiDisabledHint1Suffix")}
              </div>
              <div class="dreams-diary__empty-hint">
                ${t("dreaming.diary.memoryWikiDisabledHint2Prefix")}
                <code>plugins.entries.memory-wiki.enabled = true</code>
                ${t("dreaming.diary.memoryWikiDisabledHint2Suffix")}
              </div>
